...
- **Time-Lapse:** stage duration `30 s`, preferred minimum media size `50%`, framed/full-screen single-window overview, and pilgrim/bicycle/car/airplane/arrow marker style.
